        ...
        <div class="row">
            <div class="col-md-10 m-auto">
                <div class="post-job-form-wrapper" style="position: relative;" id="postJob">
                    ...
                    @elseif ($form_step=='three')
                    <ul id="progressbar">
                        <li class="step active" id="personal"><strong>Select Category</strong></li>
                        <li class="step active" id="professional"><strong>Budget & Setting</strong></li>
                        <li class="step active" id="address"><strong>Job Information</strong></li>
                    </ul>
                    @endif
                    @if ($form_step=='one')
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="left-content">
                                    <input type="hidden" name="cat_id" id="cat_id" value="{{ $cat_details->id }}" readonly class="form-control">
