        ...
        <div class="row">
            <div class="col-md-10 m-auto">
                <div class="post-job-form-wrapper" style="position: relative;" id="postJob">
                    ...
                    <form action="{{ url('/post/update/'.$post->id) }}" method="post" class="form-group" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col-7">
                                <h2 class="fs-title">Edit Job Post Form</h2>
                            </div>
                            <div class="col-5">
                                <h2 class="steps"></h2>
                            </div>
                        ...
                        <div class="category-items-wrap">
                            @foreach($categories as $category)
                                <div class="category-item-outer">
                                    <input type="radio" id="{{ 'cat'. $category->id }}" name="cat_id" value="{{ $category->id }}" {{ $category->id == $post->cat_id ? 'checked' : '' }} class="category-item-radio">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                 ...
                                 <input type="text" name="title" value="{{ $post->title }}" placeholder="Write an accurate job Title" class="form-control">
                            </div>
                            {{-- <div class="col-md-12">
                            ...
                            <div class="col-md-12">
                                 <div class="task-outer">
                                    ...
                                    <textarea name="required_task" id="required_task" rows="5" cols="50" class="form-control">{{ $post->required_task }}</textarea>
                                 </div>
                            </div>
                            <div class="col-md-12">
                                 <div class="task-outer">
                                    ...
                                    <img src="{{ asset('/thumbnail/'.$post->avatar) }}" height="100" width="100" />
                                 </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-12">
                                <div class="left-content">
                                    ...
                                    <input type="number" name="worker_number" value="{{ $post->worker_number }}" id="worker_number" min="1" placeholder="Minimum 1" class="form-control">
                                    <label for="worker_earn">Each worker Earn</label><span style="color: red; font-size: 16px;"> *</span><br>
                                    <input type="number" name="worker_earn" value="{{ $post->worker_earn }}" id="worker_earn" onblur="totalWorkerEarn()" placeholder="min 0.1" min="0.1" step="0.001" class="form-control">
                                    ...
                                    <input type="number" name="required_screenshot" value="{{ $post->required_screenshot }}" placeholder="0" min="1" max="2" class="form-control">
                                    <label for="estimated_date">Estimated Day</label><span style="color: red; font-size: 16px;"> *</span><br>
                                    <input type="number" name="estimated_date" value="{{ $post->estimated_date }}" placeholder="7 day" min="1" max="7" class="form-control">
                                </div>
                            </div>
                        </div>
